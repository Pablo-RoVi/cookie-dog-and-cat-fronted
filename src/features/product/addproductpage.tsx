...
const AddProductPage = () => {
  ...
  const [isConfirmationProductModalOpen, setIsConfirmationProductModalOpen] =
    useState<boolean>(false);
  const [isAddedProductModalOpen, setIsAddedProductModalOpen] =
    useState<boolean>(false);
  ...
  const [isConfirmationBrandModalOpen, setIsConfirmationBrandModalOpen] =
    useState<boolean>(false);
  const [isAddedBrandModalOpen, setIsAddedBrandModalOpen] =
    useState<boolean>(false);
    ...
    <div className="max-h-screen bg-white flex-auto flex h-1/2">
        ...
        <div className="flex items-center space-x-4">
          {isFormCompleted ? (
            <Buttons.TurquoiseButton
              text="Añadir"
              onClick={() => toggleConfirmationProductModal()}
            />
          ) : (
      ...
      <div className="container mx-auto mt-6 mr-52">
        ...
        {TableModule.inputFilter({
          ...
          errorInput:
            !Functions.verifyBrandName(newBrandName) && newBrandName !== "",
          errorMessage:
            "El nombre de la marca debe tener entre 3 y 30 caracteres del abecedario español",
        })}
